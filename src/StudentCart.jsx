  ...
  return (
    <div style={{ background: '#f8fafc', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 20px' }}>
        <h2 style={{ color: '#1e3a8a', marginBottom: '20px' }}>Borrowing Requests</h2>
          ...
          {requests.length === 0 ? (
            ...
            requests.map(req => (
              <div key={req.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '15px 0', borderBottom: '1px solid #f1f5f9' }}>
                ...
                <span style={{ background: '#fef3c7', color: '#d97706', padding: '5px 12px', borderRadius: '20px', fontSize: '0.75rem', fontWeight: 'bold' }}>
                  PENDING APPROVAL
                </span>
              </div>
            ))
